...
Copied from Xavier's implementation (xfw workspace).
"""
...
class CodebaseIndexer:
    ...
    def __init__(
        ...
        self.redis_db = redis_db or RedisDatabase(use_mock=True)
    ...
    def build_index(self) -> int:
        """Build the index for all supported files. Returns number of files indexed."""
        self.index()
        return len(self._get_files_to_index())
